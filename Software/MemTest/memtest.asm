...
;
; v1.1 - 14th August 2024
;	 Change messages from RAM finder to Mem tester.
...
BYTE_2_ASCII:
	...
	call SER_TX_CHAR		; Print out the upper nibble
	pop bc
	ld a,c
	call SER_TX_CHAR		; Print out the lower nibble
...
MSG_CRLF	.db CR, LF, 0
MSG_END		.db CR, LF, "Mem Tester complete", CR, LF, 0
MSG_INTRO	.db CR, LF, "Mem Tester", CR, LF, "==========", CR, LF, 0
...
#ifdef ROM_LOAD
PROG_END
		.org 1800h		; If ROM load then variables need to be
RAM_FOUND	.db 0			; in RAM
#else
RAM_FOUND	.db 0
PROG_END
#endif

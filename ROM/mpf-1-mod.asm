...
;*                                                         *
;*    mpf-1-mod                                            *
;*    Modifications to the original MPF-1 ROM              *
;*                                                         *
;*    Relocate RST 00H code to free up RST 08H to 20H      *
;*                                                         *
;***********************************************************
...
;***********************************************************
RST00:	.org	00H		;Required to make sure assembler doesn't skip over address 
	JP	RESET0		; Jump to the RST 00H code

;***********************************************************
RST08:	.org	08H

	JP	2FF0H		; Jump to the top of the option ROM

;***********************************************************
RST10:	.org	10H

	JP	2FF4H		; Jump to the top of the option ROM

;***********************************************************
RST18:	.org	18H

	JP	2FF8H		; Jump to the top of the option ROM

;***********************************************************
RST20:	.org	20H

	JP	2FFCH		; Jump to the top of the option ROM
...
; Executed when 'WRtape' key is pressed.
	CALL	02400H		; Call the SD card loader
	RET
KRT:
; Branched by KSUBFUN table.
; Executed when 'RDtape' key is pressed.
	...
	; CALL	STEPDP		; Display the parameter that
				...
				; ; subroutine STEPDP.
	CALL	02000H		; Call the hex load program
	RET
